...
export function DocumentPreview({ document, onClose, onDownload, className = '' }: DocumentPreviewProps) {
    ...
    const canPreview = document.fileType.toLowerCase().includes('pdf') || document.fileType.toLowerCase().includes('image');
                ...
                <div className="p-6 overflow-auto max-h-[calc(90vh-200px)]">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                        <div>
                            ...
                            <div className="font-medium text-neutral-900">{document.propertyName}</div>
                        </div>
                        {document.tenantName && (
                            <div>
                                <div className="text-sm text-neutral-500">Tenant</div>
                                <div className="font-medium text-neutral-900">{document.tenantName}</div>
                            </div>
                        )}
                        <div>
                            <div className="text-sm text-neutral-500">File Size</div>
                            <div className="font-medium text-neutral-900">{formatFileSize(document.fileSize)}</div>
                        </div>
                        <div>
