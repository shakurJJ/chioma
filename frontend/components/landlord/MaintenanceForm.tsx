...
export function MaintenanceForm({ propertyId, propertyName, onSuccess, onCancel, className = '' }: MaintenanceFormProps) {
    ...
    return (
        <form onSubmit={handleSubmit} className={`space-y-6 ${className}`}>
            <div className="bg-white rounded-3xl p-8 border border-neutral-100 shadow-sm">
                <h2 className="text-2xl font-bold text-neutral-900 mb-6">New Maintenance Request</h2>
